...
D_params = {
    ...
    'pred': 'unexpected'  # 'expected' or 'unexpected', 'neutral'
}
# Timing of task
task_info = {
    'trials': 1000,
...
for afc, coh, fr in combinations:
    ...
    full_file = f"/mnt/neurocube/local/serenceslab/holly/RNN_Geo/data/decoding/{D_params['pred']}/fr{fr}/{coh}_{afc}afc/boot_{D_params['pred']}_all{modelnum}.npz"
